...
/// <summary>
/// The weather nowcast strip: borderless, transparent, always on top, and
/// self-hiding when conditions are flat. Drag it anywhere with the left mouse
/// button; right-click for the exit menu.
/// </summary>
